...
class Product
{
    ...
    // Constructeur
    public function __construct(int $id,string $name,array $photos,int $price,string $description,int $quantity,int $category_id,DateTime $createdAt=new DateTime(),DateTime $updatedAt=new DateTime())
    {
    $this->id = $id;
    $this->name = $name;
    $this->photos = $photos;
...
$product = new Product(100, "T-shirt",['https://picsum.photos/200/300'], 299,'A nice T-shirt', 50, $category->getId());
